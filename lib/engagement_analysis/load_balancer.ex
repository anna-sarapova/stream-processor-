...
#      Logger.info("EngagementLoad Balancer: queue length #{inspect(list_length)} ", ansi_color: :cyan)
      if list_length > 0 do
#        IO.inspect("Engagement Load Balancer: worker #{inspect(pid_to_kill)} is waiting to be killed")
